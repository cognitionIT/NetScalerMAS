...
Write-Host "| 1. Adding a NetScaler instance to NetScaler MAS with PowerShell: | " -ForegroundColor Yellow
Write-Host "-------------------------------------------------------------------- " -ForegroundColor Yellow
...
#        $response.managed_device | Select-Object hostname, instance_state, is_pooled_license, is_managed, profile_name, mgmt_ip_address, status, ip_address
