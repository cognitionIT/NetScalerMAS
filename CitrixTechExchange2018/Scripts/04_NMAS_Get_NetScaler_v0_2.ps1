<#
.SYNOPSIS
  Connect to Citrix ADM and retrieve NetScaler VPX instance(s).
.DESCRIPTION
  Connect to Citrix ADM and retrieve NetScaler VPX instance(s), using REST API and JSON.
.NOTES
  Version:        0.1
...
Write-Host "| Get NetScaler instance info from Citrix ADM with PowerShell: | " -ForegroundColor Yellow
Write-Host "------------------------------------------------------------------- " -ForegroundColor Yellow
