<#
.SYNOPSIS
  Connect to Citrix ADM and create a ConfigPack for a given Stylebook.
.DESCRIPTION
  Connect to Citrix ADM and create a ConfigPack for a given Stylebook, using REST API.
.NOTES
  Version:        0.1
...
Write-Host "| Create a Configuration Pack for a Citrix ADM Stylebook with PowerShell: | " -ForegroundColor Yellow
Write-Host "------------------------------------------------------------------------------ " -ForegroundColor Yellow
...
#region End NetScaler NITRO Session
    ...
    {
        Write-Host "REST API call to logout of MAS: " -NoNewline -ForegroundColor DarkYellow
        Write-Host "Successful" -ForegroundColor Green
    }
