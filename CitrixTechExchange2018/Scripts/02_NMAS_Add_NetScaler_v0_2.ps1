<#
.SYNOPSIS
  Connect to Citrix ADM and add a NetScaler VPX instance to the console.
.DESCRIPTION
  Connect to Citrix ADM and add a NetScaler VPX instance to the console, using REST API and JSON.
.NOTES
  Version:        0.2
...
Write-Host "| Adding a NetScaler instance to Citrix ADM with PowerShell: | " -ForegroundColor Yellow
Write-Host "----------------------------------------------------------------- " -ForegroundColor Yellow
