<#
.SYNOPSIS
  Connect to Citrix ADM and proxy the NITRO request to the VPX Server.
.DESCRIPTION
  Connect to Citrix ADM and proxy the NITRO request to the VPX Server, using REST API.
.NOTES
  Version:        0.3
...
Write-Host "| Use Citrix ADM to proxy a request to NetScaler VPX with PowerShell: | " -ForegroundColor Yellow
Write-Host "-------------------------------------------------------------------------- " -ForegroundColor Yellow
